...
const TEST_QUERIES = [
	...
	{ query: '"state management"', description: 'Exact phrase query' },
	{
		...
		description: 'Another exact phrase query',
	},
	{ query: 'routing params', description: 'Multiple term query' },
	{
		query: 'component lifecycle',
		description: 'Core concepts query',
	},
	...
	{
		query: 'error warning debug',
		description: 'Multiple weighted terms',
	},
	{
		query: 'component',
	...
	{
		query: 'error',
		description: 'Error document search',
		doc_type: 'error',
	},
];
