...
// Test queries
const TEST_QUERIES = [
    { query: "How do I use svelte?", expected: true, reason: "Contains 'svelte'" },
    { query: "What is $state in Svelte 5?", expected: true, reason: "Contains 'svelte' and '$state'" },
    { query: "How do I handle component lifecycle?", expected: true, reason: "Contains 'component' and 'lifecycle'" },
    { query: "What are runes?", expected: true, reason: "Contains 'runes'" },
    { query: "How to use SvelteKit routing?", expected: true, reason: "Contains 'sveltekit' and 'routing'" },
    { query: "What's the best way to handle state management?", expected: true, reason: "Contains 'state'" },
    { query: "How do I fix this error?", expected: false, reason: "Contains 'error' but no Svelte context" },
    { query: "Svelte error handling", expected: true, reason: "Contains 'error' with 'svelte' context" },
    { query: "How to debug JavaScript?", expected: false, reason: "Contains 'debug' but no Svelte context" },
    { query: "How to debug Svelte components?", expected: true, reason: "Contains 'debug' with 'svelte' context" },
    { query: "Pizza recipes", expected: false, reason: "No Svelte terms" },
    { query: "Best store implementation", expected: false, reason: "Contains 'store' but no Svelte context" },
    { query: "Svelte store patterns", expected: true, reason: "Contains 'store' with 'svelte' context" },
    { query: "load function in JavaScript", expected: false, reason: "Contains 'load' but no Svelte context" },
    { query: "load function in SvelteKit", expected: true, reason: "Contains 'load' with 'sveltekit' context" }
];
